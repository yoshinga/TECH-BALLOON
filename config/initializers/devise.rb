...
Devise.setup do |config|
  ...
  case Rails.env
    ...
    when 'production'
      config.omniauth :facebook, ENV['FACEBOOK_ID_PRODUCTION'], ENV['FACEBOOK_SECRET_PRODUCTION'], scope: 'email', info_fields: 'email', callback_url: "https://tech-balloon.herokuapp.com/users/auth/facebook/callback"
      config.omniauth :google_oauth2, ENV['GOOGLE_ID_PRODUCTION'], ENV['GOOGLE_SECRET_PRODUCTION'], scope: 'email', redirect_uri: "https://tech-balloon.herokuapp.com/users/auth/google_oauth2/callback"
      # config.omniauth :facebook, ENV['FACEBOOK_ID_PRODUCTION'], ENV['FACEBOOK_SECRET_PRODUCTION'], scope: 'email', callback_url: "https://tech-balloon.herokuapp.com/users/auth/facebook/callback"
    end
    # config.omniauth :facebook, ENV['FACEBOOK_ID_PRODUCTION'], ENV['FACEBOOK_SECRET_PRODUCTION'], scope: 'email', info_fields: 'email', callback_url: "https://hogehoge.herokuapp.com/users/auth/facebook/callback"
  ...
  # config.secret_key = '8852e7b90e9e19b23d4fa13e8a6223cf08e42ccc44cda2ed9500d0a28b87807640fb7a386a2c1112c15fc6b99a037849de92a5eedc3d12ef1ad377d439e8af65'
  ...
  # config.pepper = 'd5c2f1de837045af11fa21d8f963aeb7dc5a08ca8f99fbb2a4c903a8238d46fd2627a59f05678eee68d2b00001a70f85daa1ee30f303629580c5c73bed22b536'
